...
#pragma warning disable CS0414
        [SerializeField] [Tooltip("The Android system permission to request")]
        string m_PermissionId = k_DefaultPermissionId;

        [SerializeField] [Tooltip("Invoked when permission is denied")]
        UnityEvent<string> m_PermissionDenied;

        [SerializeField] [Tooltip("Invoked when permission is granted")]
